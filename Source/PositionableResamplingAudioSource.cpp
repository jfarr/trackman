...
PositionableResamplingAudioSource::PositionableResamplingAudioSource(juce::PositionableAudioSource* source, const bool deleteWhenRemoved, double sourceSampleRateToCorrectFor, int maxNumChannels)
	: source(source)
