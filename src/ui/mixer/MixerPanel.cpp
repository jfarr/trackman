...
void MixerPanel::createControls() {
    ...
    //    numeratorText.onTextChange = [this] {
    //    desktopController.numeratorChanged(numeratorText.getText().getIntValue()); };
    //
...
void MixerPanel::update() {
    ...
    //        juce::String(desktopController.getProject().getTimeSignature().getNumerator()),
